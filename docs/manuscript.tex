...
there being measurement error in the exposure variable. Indeed
instrumental variable (IV) analysis was in part initially introduced as
a correction for measurement error in the exposure\textsuperscript{29},
whereas it has been noted that both classic mediation-based
...
where \(\beta_{MR} \neq 0\) denotes the existence of causality, and the
...
example, following Pierce and VanderWeele\textsuperscript{35} we can
define
...
In the causal inference test (CIT), an omnibus p-value is generated from
...
introduce the MR Steiger approach to also orient the direction of
causality in an MR analysis when the underlying biology of the SNP is
...
direction\textsuperscript{46}. In this work we assumed that pleiotropy
...
for example applying MR to genetical genomics\textsuperscript{47},
multivariate MR\textsuperscript{48} and mediation through
MR\textsuperscript{49--51} may offer more robust alternatives for these
...
35. Pierce, B. L. \& VanderWeele, T. J. The effect of non-differential
...
47. Relton, C. L. \& Davey Smith, G. Two-step epigenetic Mendelian
...
48. Burgess, S., Freitag, D. F., Khan, H., Gorman, D. N. \& Thompson, S.
...
49. Varbo, A. \emph{et al.} Remnant cholesterol, low-density lipoprotein
...
50. Burgess, S., Daniel, R. M., Butterworth, A. S. \& Thompson, S. G.
...
51. Richmond, R. C., Hemani, G., Tilling, K., Davey Smith, G. \& Relton,
