...
epidemiological literature extensively\textsuperscript{13--15}.
...
genomics\textsuperscript{16}, the regression-based causal inference test
(CIT)\textsuperscript{4,17}, a structural equation modelling (SEM)
...
in large scale `omics datasets\textsuperscript{6,18--22}.
...
the biological nature of a putative GWAS hit\textsuperscript{23}. For
...
this is because BMI causes CRP\textsuperscript{24}, but supposing we
...
methylation level, or the gene expression level\textsuperscript{25}
(Figure 1)?
...
samples\textsuperscript{26}. This has the crucial advantage of improving
...
a correction for measurement error\textsuperscript{27}, whereas it has
been noted that both classic mediation-based
analyses\textsuperscript{14,15,28,29} and mediation-based methods that
use instrumental variables\textsuperscript{30,31} are prone to be
...
the R programming language\textsuperscript{32} and code is made
...
R package \(R/systemfit\)\textsuperscript{33}.
...
within a population\textsuperscript{34}. It is calculated as
...
two-sample MR\textsuperscript{26} setting. Two-sample MR refers to the
...
\emph{R/psych}\textsuperscript{35}.
...
Two sample MR\textsuperscript{26} was performed using the summary
statistics presented in\textsuperscript{25} for each of 4122
...
in Shakhbazov et al\textsuperscript{25}. These were filtered to be
...
We performed two sample MR\textsuperscript{26} for each association in
...
reported by Shakhbazov et al\textsuperscript{25}, and that there was a
...
expression levels, consistent with expectation\textsuperscript{36}.
...
mediation is relatively well explored\textsuperscript{13}. Our analysis
...
established\textsuperscript{31} and have a number of extensions that
...
\includegraphics{manuscript_files/figure-latex/steiger_sensitivity_plot-2.pdf}
\includegraphics{manuscript_files/figure-latex/steiger_sensitivity_plot-3.pdf}
...
\(\rho_{g, x_o} > \rho_{g, y_o}\). In order to assess how reliable the
Steiger test is in the presence of measurement imprecision, we can
evaluate the range of potential values of measurement error in \(x\) and
\(y\) over which the empirical result from the Steiger test would return
the wrong value.
...
Steiger test to measurement error, the objective is to compare the
weighted proportion of the parameter space that agrees with the inferred
direction against the weighted proportion which does not:
...
13. Fewell, Z., Davey Smith, G. \& Sterne, J. A. C. The impact of
...
14. Cessie, S. le, Debeij, J., Rosendaal, F. R., Cannegieter, S. C. \&
...
15. Blakely, T., McKenzie, S. \& Carter, K. Misclassification of the
...
16. Schadt, E. E. \emph{et al.} An integrative genomics approach to
...
18. Koestler, D. C. \emph{et al.} Integrative genomic analysis
...
19. Liu, Y. \emph{et al.} Epigenome-wide association data implicate DNA
...
20. Yuan, W. \emph{et al.} An integrated epigenomic analysis for type 2
diabetes susceptibility loci in monozygotic twins. \emph{Nature
communications} \textbf{5,} 5719 (2014).

\hypertarget{ref-Tang2014}{}
21. Tang, Y. \emph{et al.} Genotype-based treatment of type 2 diabetes
...
22. Hong, X. \emph{et al.} Genome-wide association study identifies
...
23. Claussnitzer, M. \emph{et al.} FTO Obesity Variant Circuitry and
Adipocyte Browning in Humans. \emph{The New England journal of medicine}
\textbf{373,} 895--907 (2015).

\hypertarget{ref-Timpson2011}{}
24. Timpson, N. J. \emph{et al.} C-reactive protein levels and body mass
...
25. Shakhbazov, K. \emph{et al.} Shared genetic control of expression
and methylation in peripheral blood. \emph{BMC genomics} \textbf{17,}
278 (2016).

\hypertarget{ref-Pierce2013}{}
26. Pierce, B. L. \& Burgess, S. Efficient design for Mendelian
...
27. Ashenfelter, O. \& Krueger, A. B. Estimates of the Economic Return
...
28. Nagarajan, R. \& Scutari, M. Impact of noise on molecular network
inference. \emph{PloS one} \textbf{8,} e80735 (2013).

\hypertarget{ref-Shpitser2010}{}
29. Shpitser, I., VanderWeele, T. \& Robins, J. On the validity of
...
30. Wang, L. \& Michoel, T. Detection of regulator genes and eQTLs in
gene networks. \emph{arXiv} \textbf{arXiv:1512,} (2015).

\hypertarget{ref-Lagani2015}{}
31. Lagani, V., Triantafillou, S., Ball, G., Tegner, J. \& Tsamardinos,
