...
\hypersetup{unicode=true,
            pdftitle={Determining the existence and direction of causality in the face of measurement error},
            pdfborder={0 0 0},
            breaklinks=true}
...
statistics presented in\textsuperscript{18} for each of 4122
...
in Shakhbazov et al\textsuperscript{18}. These were filtered to be
