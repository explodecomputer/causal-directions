...
Supplementary figure 2 shows the relationship between the magnitude of
...
\includegraphics{../images/cit_confounder.pdf}

Supplementary figure 1: Illustrative simulations (\(n = 5000\)) showing
the results from CIT analysis under a model of confounding. Here, the
phenotypes \(x\) and \(y\) are not causally related, but there is a
genetic effect and a confounder both influencing each phenotype. Each
point represents a single simulation. Where power is high (when the
...
Supplementary figure 2: Graph representing the unmeasured confounding
