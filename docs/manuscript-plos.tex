...
\subsection{Mediation-based causal inference under measurement
...
\subsection{Using MR Steiger to infer the direction of
...
\subsection{Comparison of CIT and MR Steiger for obtaining the
...
\subsection{The causal relationship between gene expression and DNA
methylation
...
\subsection{CIT test}\label{cit-test}
...
\subsection{MR causal test}\label{mr-causal-test}
...
\subsection{Causal direction sensitivity analysis for measurement
